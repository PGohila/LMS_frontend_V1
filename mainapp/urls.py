...
#--------------- repayment 2 ----------------------
    ...
    path('template_delete/<id>', template_delete, name='template_delete'),
    path('template_edit/<id>', template_edit, name='template_edit'),

    path('templatemap_create/', templatemap_create, name='templatemap_create'),
]